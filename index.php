...
[
  'question' => "<h1>Stabilire il paese associato al tuo account</h1>",
...
<body>
    ...
    <div class="top-header">
        <div class="logo padding-10-px">
            <img src="./assets/g-logo.png" alt="">
        </div>
        <div class="privacy">
            <h1>Privacy e Termini</h1>
        </div>
    </div>
    <div class="bottom-header padding-10-px">
        <a href="#">Introduzione</a>
        <a href="#">Norme sulla Privacy</a>
        <a href="#">Termini di servizio</a>
        <a href="#">Tecnologie</a>
        <a href="#" id="faq">Domande Frequenti</a>
    </div>
    </header>
</body>
</html>